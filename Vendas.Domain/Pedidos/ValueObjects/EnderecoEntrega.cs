...
public class EnderecoEntrega : ValueObject
{
    ...
    private EnderecoEntrega(string cep, string logradouro, string numero, string complemento, string bairro, string cidade, string estado, string pais)
    {
    ...
    public static EnderecoEntrega Criar(string cep, string logradouro, string numero, string complemento, string bairro, string cidade, string estado, string pais)
    {
        return new EnderecoEntrega(cep, logradouro, numero, complemento, bairro, cidade, estado, pais);
    }
