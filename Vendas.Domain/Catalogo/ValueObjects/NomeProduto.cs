...
public sealed class NomeProduto : ValueObject
{
    ...
    public NomeProduto(string valor)
    {
        ...
        Guard.Against<DomainException>(valor.Length < 3, "O nome do produto deve conter pelo menos 3 caracteres");
        Guard.Against<DomainException>(valor.Length > 150, "O nome do produto deve conter no máximo 150 caracteres");
