...
public sealed class Produto : AggregateRoot
{
    ...
    private readonly List<ImagemProduto> _imagens = [];
    ...
    public Produto(NomeProduto nome, CodigoProduto codigo, PrecoProduto preco, Guid categoriaId, int estoqueInicial = 0, string? descricao = null)
    {
        ...
        Guard.Against<DomainException>(estoqueInicial < 0, "O estoque inicial não pode ser negativo");
    ...
    public void AlterarPreco(PrecoProduto novoPreco)
    {
        ...
        Guard.Against<DomainException>(novoPreco.Valor <= 0, "O preço deve ser maior que zero");
    ...
    public void AjustarEstoque(int quantidade, string motivo)
    {
        ...
        Guard.Against<DomainException>(Estoque + quantidade < 0, "O ajuste de estoque resultaria em um valor negativo");
    ...
    public void AdicionarImagem(ImagemProduto imagem)
    {
        ...
        Guard.Against<DomainException>(_imagens.Any(i => i.Ordem == imagem.Ordem), "Já existe uma imagem nesta ordem");
